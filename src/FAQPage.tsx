            ...
            <main lang="pt-BR">
              ...
              <QuestionBlock title="Qual é a ordem pra ler as suas histórias?">
                ...
                <QuestionBlock title="O que você acha de livros escritos com inteligência artificial?">
                  ...
                  <p>Primeiro, uma coisa bem clara: <strong>eu uso inteligência artificial no trabalho</strong>, porque a IA me auxilia como uma ferramenta, de mesma utilidade que o <i>autocomplete</i> da IDE, de uma <i>manpage</i>, ou mesmo de uma rápida pesquisa no Google. Mas isso é diferente de usá-la para escrever um livro, e tem um motivo:</p>
